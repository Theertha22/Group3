...
import com.example.regineyo.healthconnect.PatientChatActivity;
import com.example.regineyo.healthconnect.R;
...
public class calender_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorsLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(calender_page.this, PatientChatActivity.class);
